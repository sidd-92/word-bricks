//console.log('PROCESS.JS:WORD',assignedWord);
//console.log('PROCESS.JS:ANSWERS',assignedAnswers);
         ...
         if (givenAnswer in assignedAnswers) {
           ...
           if (subWordCount == totalAns) {
             //success.innerHTML = "Congrats ! Level Complete";
				addOverlay();	   
           }else{success.innerHTML = "Yes!, You Got It";}
				console.log("GIVEN ANSWERS:",givenAnswer);
